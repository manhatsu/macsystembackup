...
SECRET_KEY='3n1r7f8cj+=cxha#yv(m0b@)ozkq5#g-!9@xv_s8%vfb82tws-'
DEBUG='True'
...
__conda_setup="$('/Users/manhatsu/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/manhatsu/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/manhatsu/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/manhatsu/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
